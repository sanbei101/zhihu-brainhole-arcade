  ...
  return (
    <div className="relative flex size-full flex-col justify-between gap-6 overflow-hidden rounded-2xl border border-white/80 bg-white/80 p-6 text-slate-900 shadow-2xl backdrop-blur-md sm:rounded-3xl sm:p-10 lg:p-12">
      ...
      <div className="my-auto grid grid-cols-1 gap-6 md:grid-cols-2">
        {/* 左栏：传统知乎脑洞局限 */}
        <div className="space-y-4 rounded-2xl border-2 border-rose-200 bg-rose-50/75 p-6 shadow-md backdrop-blur-xl sm:p-8">
          ...
          <ul className="space-y-3 text-sm leading-relaxed text-slate-700 sm:text-base">
            <li className="flex items-start gap-2.5">
              ...
              <span>
                <strong className="text-slate-900">答主独白</strong>
            ...
            <li className="flex items-start gap-2.5">
              <span className="text-lg font-black text-rose-600">✕</span>
              <span>
                <strong className="text-slate-900">无法推演博弈</strong>
            ...
            <li className="flex items-start gap-2.5">
              <span className="text-lg font-black text-rose-600">✕</span>
              <span>
                <strong className="text-slate-900">消费即终结</strong>
                ：读者点赞收藏后即流失，无法在社区内二次生产新的衍生内容。
              </span>
            </li>
          </ul>
          <div className="rounded-xl border border-rose-200 bg-white/80 p-3.5 text-xs text-slate-600 italic sm:text-sm">
            “如果赤壁之战曹操大获全胜……” 过去你只能看答主脑补，今天由你亲自执掌相印！
          </div>
        </div>

        {/* 右栏：知乎脑洞游乐园创新 */}
        <div className="space-y-4 rounded-2xl border-2 border-blue-200 bg-blue-50/75 p-6 shadow-md backdrop-blur-xl sm:p-8">
          <div className="flex items-center justify-between border-b border-blue-200 pb-3">
            <span className="flex items-center gap-2.5 text-lg font-black text-[#0066ff] sm:text-xl">
              <Flame className="size-5 text-[#0066ff]" />
          ...
          <ul className="space-y-3 text-sm leading-relaxed text-slate-700 sm:text-base">
            <li className="flex items-start gap-2.5">
              <span className="text-lg font-black text-[#0066ff]">✓</span>
              <span>
                <strong className="text-slate-900">身临其境执掌天下</strong>
            ...
            <li className="flex items-start gap-2.5">
              <span className="text-lg font-black text-[#0066ff]">✓</span>
              <span>
                <strong className="text-slate-900">Multi-Agent 活体博弈</strong>
            ...
            <li className="flex items-start gap-2.5">
              <span className="text-lg font-black text-[#0066ff]">✓</span>
              <span>
                <strong className="text-slate-900">结算即内容闭环</strong>
                ：终局自动生成数千字第一人称知乎体回答与战报卡，一键发回社区原帖！
              </span>
            </li>
          </ul>
          <div className="rounded-xl border border-blue-200 bg-white/80 p-3.5 text-xs font-bold text-[#0066ff] sm:text-sm">
      ...
      {/* 底部：闭环机制流水线大尺寸展示 */}
      <div className="rounded-2xl border border-slate-200/90 bg-white/90 p-5 shadow-sm backdrop-blur-xl">
        <div className="mb-3 flex items-center justify-between font-mono text-xs text-slate-600 sm:text-sm">
          <span className="flex items-center gap-2 font-bold text-slate-900">
            <Layers className="size-4 text-[#0066ff]" />
            <span>【知乎脑洞游乐园 · 闭环飞轮】</span>
          </span>
          <span className="text-sm font-bold text-[#0066ff]">输入 ➔ 博弈 ➔ 分叉 ➔ 社区输出</span>
        </div>
        <div className="grid grid-cols-2 gap-4 text-center sm:grid-cols-4">
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 transition-colors hover:bg-slate-100">
            <div className="mb-1.5 text-2xl">🏛️</div>
            <div className="text-sm font-bold text-slate-900 sm:text-base">1. 知乎母本选题</div>
            <div className="mt-1 text-xs text-slate-500">10 大历史/科幻脑洞副本</div>
          </div>
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 transition-colors hover:bg-slate-100">
            <div className="mb-1.5 text-2xl">🎭</div>
            <div className="text-sm font-bold text-slate-900 sm:text-base">2. Multi-Agent 博弈</div>
            <div className="mt-1 text-xs text-slate-500">四方势力施压与通牒</div>
          </div>
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 transition-colors hover:bg-slate-100">
            <div className="mb-1.5 text-2xl">🌟</div>
            <div className="text-sm font-bold text-slate-900 sm:text-base">3. 天命分叉决策</div>
            <div className="mt-1 text-xs text-slate-500">A/B/C/D 梯度破壁选项</div>
          </div>
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-3.5 transition-colors hover:bg-slate-100">
            <div className="mb-1.5 text-2xl">📜</div>
            <div className="text-sm font-bold text-slate-900 sm:text-base">4. 结算知乎长回答</div>
            <div className="mt-1 text-xs text-slate-500">万字亲历复盘一键发帖</div>
          </div>
        </div>
      </div>
    </div>
