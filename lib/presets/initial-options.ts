  ...
  "three-kingdoms-chibi-win": {
    ...
    player_xunyu: {
      ...
      options: [
        ...
        },
        {
          ...
          risk: "狂",
          epigraph:
            "汉家四百年若只有九州之大，这天下不要也罢！天下若容不下汉室，汉室便去重造一个天下！",
          crisisAction: true,
          impact: { stability: "↓", morale: "↑↑", support: "↑↑", resources: "↓↓" },
          forecast: [
            { agentId: "agent_caocao", lean: "doubt" },
    ...
    player_caopi: {
      ...
      options: [
        ...
        {
          id: "D",
          title: "铸铁立极·尽融降军兵戈为工坊水排",
          desc: "力排众议尽缴荆扬降卒兵甲熔铸工坊水排，以墨家重机大兴江淮盐铁实业，立不拔之基！",
          risk: "狂",
          epigraph: "与其在腐朽的朝堂上争抢残羹，不如以百工铁器重铸这万里山河！",
          crisisAction: false,
          impact: { stability: "↑", morale: "↓↓", support: "↑↑", resources: "↑↑" },
          forecast: [
            { agentId: "agent_caocao", lean: "back" },
    ...
    player_zhugejin: {
      ...
      options: [
        ...
        {
          id: "D",
          title: "裂土泛海·献万帆南洋航海图引曹军南向",
          desc: "当堂展开父辈密藏的极南海图，劝曹操以江东楼船直挂重洋建万世不拔之业，解江东兵燹！",
          risk: "狂",
          epigraph: "星汉浩渺，苍海无垠。让中原的刀戟去劈开大洋，江东父老方有一线生机！",
          crisisAction: true,
          impact: { stability: "↓↓", morale: "↑↑", support: "↑↑", resources: "↓" },
          forecast: [
            { agentId: "agent_caocao", lean: "back" },
